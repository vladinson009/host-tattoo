                        ...
                        comments.map((comment) => (
                            <Fragment key={comment.objectId} >
                                <div className="mb-2 p-2 bg-gray-800 rounded-lg">
                                    <p className="text-gray-300 text-3xl sm:text-3xl md:text-4xl">{comment.comment}</p>
                                </div>
                                <div className="pb-15">
                                    <p className="text-gray-300">By: <span className="text-red-600 text-2xl sm:text-2xl md:text-3xl"> {comment.ownerId.username}</span></p>
